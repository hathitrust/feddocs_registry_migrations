...
=begin
=end
RegistryRecord.where(series:"Federal Register",
...
SourceRecord.where(series: "FederalRegister",
  ...
  src.enum_chrons.each do | ec | 
    if regrec = RegistryRecord.where(series:"Federal Register", 
    ...
    regrec.series = "Federal Register"
    regrec.save
  end
  src.save

...
include Registry
# Parse enumchrons for Nautical Almanac registry records 
#
#
ocns = [1286390, 590966108, 609507858]
...
puts "Nautical Almanac sources: #{source_count}"
puts "Initial RR count: #{rr_count}"
deprecate_count = 0
rr_count = 0

SourceRecord.where(series:'Nautical Almanac', 
